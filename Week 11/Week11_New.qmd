---
title: "Week 11: Data Analysis and Interpretation Part II"
...
Only 6 weeks left! ALL IRBs have been submitted

Goal is to launch survey as soon as possible (continue to build Qualtrics surveys)

We will work with as many people as we can get!

After Paper #3, front end of study (lit review, RQs/Hs, should be complete)
...
## Brief Review on BG and WS Difference Tests {.smaller}
...
-   ANCOVA, MANOVA, Repeated Measures MANOVA (Sort of)
...
-   A 2 x 3 x 2 mixed design with repeated measures on the third variable, 1 normally-distributed DV
    -   EX: Do gender and class time (morning, noon, night) lead students to have better grades between Fall and Spring semester?
-   1 between groups IV (4 levels), 3 normally-distributed DVs
    -   EX: Does teacher type (lecturer, non-tenured professor, graduate student, tenured professor) differ in terms of their credibility (competence, caring, goodwill)?
:::
...
![](images/screen5.png){fig-align="center" width="800"}

### Option 2

![](images/screen6.png){fig-align="center" width="800"}
:::
...
![](images/screen7.png){fig-align="center" width="800"}

### Test?

![](images/screen8.png){fig-align="center" width="800"}
:::
...
![](images/screen9.png){fig-align="center" width="800"}

### Option 1

![](images/screen10.png){fig-align="center" width="800"}

### Option 2

![](images/screen11.png){fig-align="center" width="800"}

### Option 3

![](images/screen12.png){fig-align="center" width="800"}
:::
...
H2: Which is the best predictor of perceived stress: control of external events (mastery scale) or control of internal states (PCOISS)?
...
-   Cannot say 'predict' unless design is experimental
