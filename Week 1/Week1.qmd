...
We will end with the required *RCR 1 hour in-person training* component. You will be the first grad students to get this!
...
-   Potential Research FOCUS for Spring 2023
-   Fun Fact!
...
::: columns
::: {.column width="40%"}
-   Assistant Professor of Information Communication Technology and Instructional Communication Research
...
::: {layout-nrow="3"}
![Elizabeth Abel](Images/xsmall.jpeg){fig-align="left"}

![Madelyn Anderson](Images/xsmall-2.jpeg){fig-align="left"}

![Ikeola Bodunde](Images/xsmall-3.jpeg){fig-align="left"}

![Ivy Brashear](Images/xsmall-4.jpeg){fig-align="left"}

![Jordan DeLuce](Images/xsmall-5.jpeg){fig-align="left"}

![Luke Fetzer](Images/xsmall-6.jpeg){fig-align="left"}

![Ansley George](Images/xsmall-7.jpeg){fig-align="left"}

![Serena Hanson](Images/xsmall-8.jpeg){fig-align="left"}

![Marian Jaitto-Jeffrey](Images/xsmall-9.jpeg){fig-align="left"}

![Courtney Kleppinger](Images/xsmall-10.jpeg){fig-align="left"}

![Jacob Locke](Images/xsmall-11.jpeg){fig-align="left"}

![Anthony Martinez](Images/xsmall-12.jpeg){fig-align="left"}

![Erica Mattingly](Images/xsmall-13.jpeg){fig-align="left"}

![Mark Ribott](Images/xsmall-14.jpeg){fig-align="left"}

![Savannah Tucker](Images/xsmall-15.jpeg){fig-align="left"}
:::
...
-   Keep track of your burning questions as you go
...
**Readings**: [Course Schedule](https://uk.instructure.com/courses/2061567/pages/weekly-schedule-slash-assigned-readings)
...
**APA Template**: [Canvas](https://uk.instructure.com/courses/2061567/files/folder/Uploaded%20Media)
...
-   Locate, critically read, summarize, and critique reports of empirical research; - Write transparent reports of studies using quantitative research methods.
...
-   Final Group Research Paper (300)
...
You will work in groups of 3 to complete your own, data-driven research paper. You can decide your groups based on today's introductions and research interests. Topics need to be approved by 1/27.
...
To make trusthworhty *generalizations*...
...
Basically, people have done some messed up stuff.
...
![](Images/CITI.png){fig-align="center"}
**DUE**: January 16th
