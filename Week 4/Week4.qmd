...
issue of causal relationships is not relevant.
...
Measurement is often reliable. Participants who score low on a measure may score higher (closer to the mean) the next time.
...
*Sampling* is the process of selecting part of a larger group of participants with the intent of generalizing from the sample (the smaller group) to the population
(the larger group).
